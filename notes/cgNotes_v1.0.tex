...
\include{cgNotes-config}

\author{Giacomo Pannocchia} 
\title{\textcolor{black}{NOTES ON}\\ \textcolor{RawSienna}{Gravity and Cosmology} \\ \vspace{7pt}\large \quad \quad \quad \quad \quad \textcolor{black}{version 1.0}}
\date{a.y. 2025-2026}
